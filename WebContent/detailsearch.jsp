...
<script type="text/javascript">
	$(document).ready(function(){
		<%-- var li = $("div.z_inx_1").click(function(){
			window.location.replace("<%=basePath%>./sd/main.jsp");
		}); --%>
        var lia = $("span.float_r").click(function(event) {
            window.location.replace("<%=basePath%>./shop.jsp");
        });
	});
	</script>
</head>
	...
	<div class="width100 float_l height80 line_hei80">
        ...
        <div class="float_r">
            ...
            <div class="float_l margin_l30 margin_r40">
				<a href="login.jsp" style="color:#333333">登录</a> | <a href="regedit.jsp" style="color:#333333">注册</a>
            </div>
        </div>
	</div>
</div>
		...
		<%}%>
        	...
        	<div class="width_224 height172 float_l margin_r20 border_shadow jingguoxianshi over_pos bianshou">
                ...
                <div class="width100 float_l padding_lr20 height48 fon_siz12 line_hei48 z_inx_3 posi_relative backg_white">
                    ...
                    <span class="float_r color_gray">添加购物车</span>
            	</div>
            </div>    
            </td>
			<%i++;%>
