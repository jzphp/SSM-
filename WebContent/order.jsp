...
<body class="backg_huibai">
	...
	<form action="PayServ" method="post">
		<table width="100%" border="0" cellspacing="0" cellpadding="0" id="shopping">
			<tr>
				<td class="title_2">购买者姓名</td>
				<td class="title_3">购买的课程名称</td>
				<td class="title_4">购买的视频类型</td>
				<td class="title_5">授课人</td>
				<td class="title_7">价格</td>
				<td class="title_8">日期</td>
			</tr>
			<c:forEach items="${orderlist}" var="li">
				<tr>
					<td class="cart_td_2">${li.uname}</td>
					<td class="cart_td_3">${li.cname}</td>
					<td class="cart_td_4">${li.ctype}</td>
					<td class="cart_td_5">${li.tname }</td>
					<td class="cart_td_7">${li.cprice }</td>
					<td class="cart_td_8">${li.deta }</td>
				</tr>
			</c:forEach>
			<tr  colspan="7" >
				<td ><input type="submit" value="付款" style="border:0px;"></td>
			</tr>
		</table>
