...
<body>
    ...
    <div class="register_content clearfix"
             ...
             >
                ...
                <form action="TregisterServ" id="my_from" method="post">
            <div class="register_box myfr">
                <div class="title clearfix">
                    <span class="myfl"></span>
                    <h1 class="myfl">教师注册</h1>
                ...
                <!--  <input type="text" placeholder="请输入任职学校" name="school" class="phone_num" value="" />-->
