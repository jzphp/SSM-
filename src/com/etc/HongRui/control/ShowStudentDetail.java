...
/**
 * Servlet implementation class ShowStudentDetail
 */
...
public class ShowStudentDetail extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			student=service.showStudent(id);
			request.getSession().setAttribute("student", student);
			request.getRequestDispatcher("admin/student-info.jsp").forward(request, response);
